						...
						<div className="row">
							<div className="col-md-4 course">
								<div className="course-item-wrap wow fadeInUp animated">
									<Link href="/blog-single" className="image-course">
										...
										<img src="images/retinal/tutorial1.jpg" alt="" style={{ width: '450px', height: '550px' }} />
									</Link>
							...
							<div className="col-md-4 course">
								<div className="course-item-wrap wow fadeInUp animated">
									<Link href="/blog-single" className="image-course">
										{/* <span className="date-course">21 Oct</span> */}
										<img src="images/retinal/tutorial2.jpg" alt="" style={{ width: '450px', height: '550px' }}/>
									</Link>
									<div className="content-course">
							...
							<div className="col-md-4 course">
								<div className="course-item-wrap wow fadeInUp animated">
									<Link href="/blog-single" className="image-course">
										{/* <span className="date-course">21 Oct</span> */}
										<img src="images/retinal/tutorial3.jpg" alt="" style={{ width: '450px', height: '550px' }}/>
									</Link>
									<div className="content-course">
