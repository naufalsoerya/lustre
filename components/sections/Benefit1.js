					...
					<div className="row team">
						<div className="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3 col-xxl-3">
							<div className="team-item wow fadeInUp animated " data-wow-delay="0.1s">
								<div className="team-image">
									<img src="images/landing/landing-1.jpg" alt="Team member" style={{ width: '420px', height: '420px' }}/>
						...
						<div className="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3 col-xxl-3">
							<div className="team-item wow fadeInUp animated " data-wow-delay="0.3s">
								<div className="team-image">
									<img src="images/landing/landing-2.jpg" alt="Team member" style={{ width: '420px', height: '420px' }}/>
									<div className="shape-team" />
								</div>
							</div>
						</div>
						<div className="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3 col-xxl-3">
							<div className="team-item wow fadeInUp animated " data-wow-delay="0.5s">
								<div className="team-image">
									<img src="images/landing/landing-3.jpg" alt="Team member"style={{ width: '420px', height: '420px' }} />
									<div className="shape-team" />
								</div>
							</div>
						</div>
						<div className="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3 col-xxl-3">
							<div className="team-item wow fadeInUp animated " data-wow-delay="0.7s">
								<div className="team-image">
									<img src="images/landing/landing-4.jpg" alt="Team member" style={{ width: '420px', height: '420px' }}/>
									<div className="shape-team" />
								</div>
							</div>
						</div>
